...
<div id="header" class="wrap">
	...
	<div class="help"><a href="#" class="shopping">购物车</a><a href="./usermember/login.html">登录</a><a href="./usermember/register.html">注册</a></div>
</div>
<div id="childNav">
	<div class="wrap">
		<ul class="clearfix">
...
<div id="main" class="wrap">
	<div class="lefter">
		<div class="box">
			...
			<dl>
				<dt>百货</dt>
				<dd><a href="jacket-list.jsp">笔记本电脑</a></dd>
				<dd><a href="trousers-list.jsp">台式电脑</a></dd>
				<dd><a href="beauty-list.jsp">平板</a></dd>
				<dd><a href="fresh-list.jsp">手机</a></dd>
				<dd><a href="food-list.jsp">照相机</a></dd>
				<dd><a href="books-list.jsp">智能空调</a></dd>
			</dl>
		</div>
